            ...
            {aiMode && (
              <div className="flex flex-col gap-2">
                <textarea
                  ...
                  placeholder="e.g. Never claim expertise in AWS, Azure, or GCP. Don't mention my education at Example State. Always include my LinkedIn URL https://linkedin.com/in/myprofile. Don't use more than 20+ years of experience. Never mention Rust, Helm, or ArgoCD."
